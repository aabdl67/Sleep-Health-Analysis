...
### Find minimum and maximum systolic pressure

```         
range(sleep_data$Systolic, na.rm = TRUE)
```

### Find minimum and maximum diastolic pressure

```         
range(sleep_data$Diastolic, na.rm = TRUE)
```
